...
public class VRoleSystemModel implements java.io.Serializable {
	...
	// Fields
		...
		/** full constructor */
		public VRoleSystemModel(Integer id, Integer roleid, String rolename, Integer sysid, String menuname,
				String chinesename, String navurl, Integer accesslevel, Integer deepth, Integer parentid,
				Integer displayorder, String imageurl, String value, String systemname, Boolean isdelete, Boolean isedit,
