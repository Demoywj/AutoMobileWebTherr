...
public class TSystemModel implements java.io.Serializable {
	...
	/** full constructor */
	public TSystemModel(String name, String chinesename, String navurl, Integer accesslevel, Integer deepth,
			Integer parentid, Integer displayorder, String imageurl, String value, String systemname,
			Boolean isdelete) {
		this.name = name;
